...
Writing a skill is not a technical task. It's the same thing you'd do if you were explaining a process to a capable new colleague: describe what needs to happen, in what order, and what good looks like at the end.
...
That took about five minutes to write. Run it once, refine it once, and you have a skill that saves time every Friday for as long as you're doing standups.
