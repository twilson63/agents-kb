...
- Blocker: Substack needs login; social auth expired (X/LinkedIn/Substack) — 48+ days stale
...
- Content engine social auth still expired (X/LinkedIn/Substack) — 48+ days stale
- PR #2 (scout-live) open since Mar 7 (62+ days)
