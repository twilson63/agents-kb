...
## Content Engine
- Checked `~/onhyper/blog/` — folder empty for 8+ consecutive days, no unpublished drafts
- Blocker: No content in queue + social auth expired (X/LinkedIn/Substack) — 58+ days stale
...
- Content engine social auth still expired (X/LinkedIn/Substack) — 58+ days stale
- Content pipeline blocked — no drafts in ~/onhyper/blog/ for 8+ consecutive days
- PR #2 (scout-live) open since Mar 7 (68+ days)
