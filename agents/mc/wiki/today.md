...
## Content Engine
- Checked `~/onhyper/blog/` — folder empty for 5+ consecutive days, no unpublished drafts
...
- Content pipeline blocked — no drafts in ~/onhyper/blog/ for 5+ consecutive days
- PR #2 (scout-live) open since Mar 7 (66+ days)
