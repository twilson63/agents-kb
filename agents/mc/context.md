...
- **LinkedIn PM sessions blocked** — Chrome not running in evenings; AM sessions work via openclaw browser
- **Gmail browser session needs re-auth again** (Jun 20) — API access via gog CLI still works profile
